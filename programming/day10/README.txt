...
SelectSort.java - implements the ISort interface, sorts an array using selection sorting methods
MergeSort.java - implements the ISort interface, sorts an array using merge sorting methods
